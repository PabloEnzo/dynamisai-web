const phases = [
  ...
  },
  {
    ...
    items: ["Entrenamiento KronTokenizer (vocab 8k)", "FLEURS ES + MLS ES + LibriSpeech EN", "Validación calidad datos", "Preparación corpus reuniones (prerequisito Summarizer)"],
  },
  {
    number: "2",
    ...
    items: ["Entrenamiento 100k steps en GPU propio", "WER 21,8% (MLS) / 36,6% (FLEURS)", "CER 7,8%", "Integración live MeetingScribe — endpoint + webm + auth"],
  },
  {
    number: "3",
