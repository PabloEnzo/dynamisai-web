      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col gap-8">
          {projects.map((project) => (
            <div key={project.name} className="card-white rounded-3xl overflow-hidden hover:scale-[1.005] transition-transform duration-300">
                ...
                <div className="flex flex-col md:flex-row md:items-start gap-8">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-14 h-14 rounded-2xl bg-[#eef5ff] flex items-center justify-center text-3xl shrink-0">
                        {project.emoji}
                      </div>
                      <div>
        ...
        <div className="mt-6 rounded-2xl border border-dashed border-[#b0ccf0] p-6 flex items-center gap-4 bg-[#f8fbff]">
          <div className="w-10 h-10 rounded-xl bg-[#eef5ff] border border-[#0055e0]/15 flex items-center justify-center text-xl shrink-0">
            ⏳
          </div>
          <div>
